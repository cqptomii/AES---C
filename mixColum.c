...
void mixColumn(unsigned char column[]){
    ...
    unsigned char mult3[256]={0x00,0x03,0x06,0x05,0x0c,0x0f,0x0a,0x09,0x18,0x1b,0x1e,0x1d,0x14,0x17,0x12,0x11,
    ...
    column[0] = mult2[cpy[0]] ^ cpy[3] ^ cpy[2] ^ mult3[cpy[1]];

    column[1] =  mult2[cpy[1]] ^ cpy[0] ^ cpy[3] ^ mult3[cpy[2]];

    column[2] = mult2[cpy[2]] ^ cpy[1] ^ cpy[0] ^ mult3[cpy[3]];
...
void invMixColumn(unsigned char column[]){
    ...
    unsigned char mult11[256]={0x00,0x0b,0x16,0x1d,0x2c,0x27,0x3a,0x31,0x58,0x53,0x4e,0x45,0x74,0x7f,0x62,0x69,
    ...
    unsigned char mult13[256]={0x00,0x0d,0x1a,0x17,0x34,0x39,0x2e,0x23,0x68,0x65,0x72,0x7f,0x5c,0x51,0x46,0x4b,
    ...
    unsigned char mult14[256]={0x00,0x0e,0x1c,0x12,0x38,0x36,0x24,0x2a,0x70,0x7e,0x6c,0x62,0x48,0x46,0x54,0x5a,
    ...
    column[0] = mult14[cpy[0]] ^mult9[cpy[3]] ^ mult13[cpy[2]] ^ mult11[cpy[1]];
    column[1] = mult14[cpy[1]] ^ mult9[cpy[0]] ^ mult13[cpy[3]] ^ mult11[cpy[2]];
    column[2] = mult14[cpy[2]] ^ mult9[cpy[1]] ^ mult13[cpy[0]] ^ mult11[cpy[3]];
    column[3] = mult14[cpy[3]] ^ mult9[cpy[2]] ^ mult13[cpy[1]] ^ mult11[cpy[0]];
}
